...
public class VendorControllerTest  extends AbstractRestControllerTest {
    ...
    public void getVendorList() throws Exception {
        ...
        mockMvc.perform(get(VendorController.BASE_URL)
                ...
                // ja .andExpect(jsonPath("$.vendors", hasSize(2)));
    }
    ...
    public void createNewVendor() throws Exception {
        ...
        mockMvc.perform(post(VendorController.BASE_URL)
                ...
                .andExpect(jsonPath("$.name", equalTo(vendorDTO_1.getName())));
        	//TODO: Same case of content-body null
    }

    @Test
    public void updateVendor() throws Exception {

        given(vendorService.updateVendor(any(VendorDTO.class), anyLong())).willReturn(vendorDTO_1);
    ...
    public void patchVendor() throws Exception {
        given(vendorService.patchVendor(any(VendorDTO.class), anyLong())).willReturn(vendorDTO_1);
